...
def obtenerValorExtracto(id_asociado, saldos, mes):
    ...
    try:
        ...
        if mes.pk >= parametro.primerMes.pk:
            ...
            objTarifaAsociado = TarifaAsociado.objects.select_related("asociado", "asociado__mpioResidencia").get(asociado=id_asociado)
