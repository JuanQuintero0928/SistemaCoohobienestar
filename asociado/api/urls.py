...
from .views import obtener_total_tarifa, obtener_datos_formato_registro, obtener_datos_servicios_exequiales, obtener_datos_auxilio_economico, obtener_datos_solicitud_credito
...
urlpatterns = [
    ...
    path('obtener_datos_solicitud_credito/<int:asociado_id>/<str:tipo_formato>/<int:credito_id>/', login_required(obtener_datos_solicitud_credito), name='obtener_datos_solicitud_credito'),
]