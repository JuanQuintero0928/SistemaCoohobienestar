...
class VerAsociado(ListView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            query_mpio = Municipio.objects.values('id','nombre','departamento')
