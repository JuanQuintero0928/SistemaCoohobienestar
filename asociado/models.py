...
class Asociado(models.Model):
    ...
    tPersona = models.CharField(
        "Tipo Persona",
        choices=tipoPersonaOp.choices,
        default=tipoPersonaOp.pNatural,
        blank=False,
        null=False,
    )
    tAsociado = models.ForeignKey(
        TipoAsociado, on_delete=models.RESTRICT, blank=False, null=False
    )
    ...
    tipoDocumento = models.CharField(
        "Tipo Documento",
        choices=tipoDocumentoOp.choices,
        default=tipoDocumentoOp.cedula,
        blank=False,
        null=False,
    )
    numDocumento = models.CharField(
        "Número Documento", max_length=11, blank=False, null=False
    )
    fechaExpedicion = models.DateField("Fecha Expedicion", blank=False, null=False)
    mpioDoc = models.ForeignKey(
        Municipio, on_delete=models.RESTRICT, blank=False, null=False
    )
    nacionalidad = models.CharField(
        "Nacionalidad", max_length=30, null=False, blank=False
    )
    ...
    estadoCivil = models.CharField(
        "Estado Civil",
        choices=estadoCivilOp.choices,
        default=estadoCivilOp.soltero,
        blank=False,
        null=False,
    )
    ...
    dtoNacimiento = models.ForeignKey(
        Departamento,
        on_delete=models.RESTRICT,
        blank=True,
        null=True,
        related_name="dtoNacimiento",
    )
    mpioNacimiento = models.ForeignKey(
        Municipio,
        on_delete=models.RESTRICT,
        blank=True,
        null=True,
        related_name="mpioNacimiento",
    )
    tipoVivienda = models.CharField(
        "Tipo Vivienda",
        choices=tipoViviendaOp.choices,
        default=tipoViviendaOp.propia,
        blank=True,
        null=True,
    )
    ...
    deptoResidencia = models.ForeignKey(
        Departamento,
        on_delete=models.RESTRICT,
        blank=True,
        null=True,
        related_name="deptoResidencia",
    )
    mpioResidencia = models.ForeignKey(
        Municipio,
        on_delete=models.RESTRICT,
        blank=True,
        null=True,
        related_name="mpioResidencia",
    )
    numResidencia = models.CharField(
        "Numero Residencia", max_length=13, blank=True, null=True
    )
    indicativoCelular = models.ForeignKey(
        Pais, on_delete=models.RESTRICT, blank=True, null=True
    )
    numCelular = models.CharField(
        "Numero Celular", max_length=13, blank=False, null=False
    )
    envioInfoCorreo = models.BooleanField("Envio Información Email", default=False)
    envioInfoMensaje = models.BooleanField(
        "Envio Información Mensaje Texto", default=False
    )
    envioInfoWhatsapp = models.BooleanField("Envio Información WhatsApp", default=True)
    nivelEducativo = models.CharField(
        "Nivel Educativo",
        choices=nivelEducativoOp.choices,
        default=nivelEducativoOp.secundaria,
        blank=False,
        null=False,
    )
    tituloPregrado = models.CharField(
        "Titulo Pregrado", max_length=100, blank=True, null=True
    )
    tituloPosgrado = models.CharField(
        "Titulo Posgrado", max_length=100, blank=True, null=True
    )
    estadoAsociado = models.CharField(
        "Estado Asociado",
        choices=estadoAsociadoOp.choices,
        default=estadoAsociadoOp.activo,
        blank=False,
        null=False,
    )
    ...
    zonaUbicacion = models.CharField(
        choices=zonaUbicacionOp.choices,
        blank=True,
        null=True,
        default=zonaUbicacionOp.URBANA,
        max_length=6,
    )
    empleadoCooho = models.CharField(max_length=2, default="NO", blank=True, null=True)
    nPersonasCargo = models.IntegerField(
        "Número Personas a Cargo", blank=True, null=True
    )
    ...
    fechaActualizacionDatos = models.DateField(
        "Fecha Actualizacion Datos", blank=True, null=True
    )
...
class Laboral(models.Model):
    ...
    asociado = models.ForeignKey(
        Asociado, on_delete=models.RESTRICT, blank=False, null=False
    )
    ocupacion = models.CharField(
        choices=OcupacionOp.choices,
        default=OcupacionOp.empleado,
        max_length=50,
        blank=True,
        null=True,
    )
    ocupacionOtro = models.CharField(
        "Otra Ocupacion", max_length=50, blank=True, null=True
    )
    tipoEmpresa = models.CharField(
        choices=TipoEmpresaOp.choices,
        default=TipoEmpresaOp.publica,
        max_length=50,
        blank=True,
        null=True,
    )
    tipoEmpresaOtro = models.CharField(
        "Otro Tipo Empresa", max_length=50, blank=True, null=True
    )
    nombreEmpresa = models.CharField(
        "Nombre Empresa", max_length=50, blank=True, null=True
    )
    cargo = models.CharField("Dirección", max_length=50, blank=True, null=True)
    tipoContrato = models.CharField(
        choices=TipoContratoOp.choices,
        default=TipoContratoOp.indefinido,
        max_length=30,
        blank=True,
        null=True,
    )
    ...
    nomRepresenLegal = models.CharField(
        "Nombre Representante Legal", max_length=50, blank=True, null=True
    )
    numDocRL = models.IntegerField(
        "Numero Documento Representante", blank=True, null=True
    )
    nomJefeInmediato = models.CharField(
        "Nombre Jefe Inmediato", max_length=50, blank=True, null=True
    )
    telefonoJefeInmediato = models.CharField(
        "Telefono Jefe Inmediato", blank=True, null=True
    )
    direccion = models.CharField("Direccion", max_length=100, blank=True, null=True)
    dptoTrabajo = models.ForeignKey(
        Departamento, on_delete=models.RESTRICT, blank=True, null=True
    )
    mpioTrabajo = models.ForeignKey(
        Municipio, on_delete=models.RESTRICT, blank=True, null=True
    )
    ...
    admRP = models.CharField(
        "Administra RP",
        choices=Opciones.choices,
        default=Opciones.no,
        blank=False,
        null=False,
    )
    pep = models.CharField(
        "PEP", choices=Opciones.choices, default=Opciones.no, blank=False, null=False
    )
    activEcono = models.CharField(
        "Actividad Economica", max_length=30, blank=True, null=True
    )
    ciiu = models.CharField("CIIU", max_length=6, blank=True, null=True)
    declaraRenta = models.CharField(
        "Declara Renta",
        choices=Opciones.choices,
        default=Opciones.no,
        blank=False,
    ...
    responsableIva = models.CharField(
        "Responsable IVA",
        choices=Opciones.choices,
        default=Opciones.no,
        blank=False,
    ...
    regimenTributario = models.CharField(
        "Regimen Tributario", max_length=30, blank=True, null=True
    )
    banco = models.CharField("Banco", max_length=30, blank=True, null=True)
    tipoCuenta = models.CharField(
        "Tipo Cuenta", choices=TipoCuentaOp.choices, blank=True, null=True
    )
...
class Financiera(models.Model):
    ...
    ingrCompensacion = models.IntegerField(
        "Ingreso Compensacion", blank=True, null=True
    )
    ...
    ingrArrendamientos = models.IntegerField(
        "Ingreso Arrendamientos", blank=True, null=True
    )
    ingrOtros = models.IntegerField("Ingreso Otros", blank=True, null=True)
    ingrDescripcionOtros = models.CharField(
        "Descripcion Otros Ingresos", max_length=40, blank=True, null=True
    )
    egrArrendamiento = models.IntegerField(
        "Egreso Arrendamientos", blank=True, null=True
    )
    egrServiciosPublicos = models.IntegerField(
        "Egreso Arrendamientos", blank=True, null=True
    )
    ...
    egrCostos = models.IntegerField(
        "Egreso Costos y gastos ventas", blank=True, null=True
    )
    ...
    egrDescripcionOtros = models.CharField(
        "Descripcion Otros Egresos", max_length=40, blank=True, null=True
    )
    operacionesMonedaExtranjera = models.CharField(
    ...
    operacionesMonedaCuales = models.CharField(
        "Operaciones Moneda Cuales", max_length=50, blank=True, null=True
    )
    operacionesMonedaTipo = models.CharField(
        "Tipo producto u operacion", max_length=50, blank=True, null=True
    )
    operacionesMonedaMonto = models.IntegerField("Monto", blank=True, null=True)
    operacionesMoneda = models.CharField(
        "Tipo Moneda Extranjera", max_length=50, blank=True, null=True
    )
    poseeCuentasMonedaExtranjera = models.CharField(
        "Posee Cuentas Moneda Extranjera",
        choices=Opciones.choices,
        default=Opciones.no,
        blank=True,
        null=True,
    )
    poseeCuentasBanco = models.CharField(
        "Posee Cuentas en Otros Bancos", max_length=50, blank=True, null=True
    )
    poseeCuentasCuenta = models.IntegerField("Cuenta", blank=True, null=True)
    poseeCuentasMoneda = models.CharField(
        "Moneda", max_length=50, blank=True, null=True
    )
    poseeCuentasCiudad = models.CharField(
        "Ciudad", max_length=50, blank=True, null=True
    )
    ...
    def total_ingresos(self):
        campos = [
            self.ingrSalario,
            self.ingrHorasExtras,
            self.ingrPension,
            self.ingrCompensacion,
            self.ingrHonorarios,
            self.ingrVentas,
            self.ingrIntereses,
            self.ingrGiros,
            self.ingrArrendamientos,
            self.ingrOtros,
        ]
    ...
    def total_egresos(self):
        campos = [
            self.egrArrendamiento,
            self.egrServiciosPublicos,
            self.egrAportesSalud,
            self.egrTransporte,
            self.egrAlimentacion,
            self.egrObligaciones,
            self.egrTarjetas,
            self.egrCostos,
            self.egrEmbargos,
            self.egrOtros,
...
class TarifaAsociado(models.Model):
    ...
    cuotaRepatriacionBeneficiarios = models.IntegerField(
        "Repatriacion Beneficiarios", blank=True, null=True
    )
    cuotaRepatriacionTitular = models.IntegerField(
        "Repatriacion Titular", blank=True, null=True, default=0
    )
    cuotaSeguroVida = models.IntegerField("Seguro Vida", blank=True, null=True)
    fechaInicioAdicional = models.DateField(
        "Fecha Inicio Adicional", blank=True, null=True
    )
    ...
    cuotaCoohopAporte = models.IntegerField(
        "Coohoperativito Aporte", blank=True, null=True
    )
    cuotaCoohopBsocial = models.IntegerField(
        "Coohoperativito Bienestar Social", blank=True, null=True
    )
...
class ParametroAsociado(models.Model):
    ...
    funeraria = models.ForeignKey(
        ServicioFuneraria, on_delete=models.RESTRICT, blank=False, null=False
    )
    primerMes = models.ForeignKey(
        MesTarifa, on_delete=models.RESTRICT, blank=True, null=True
    )
    tarifaAsociado = models.ForeignKey(
        TarifaAsociado, on_delete=models.RESTRICT, blank=True, null=True
    )
    vinculacionFormaPago = models.ForeignKey(
        FormaPago, on_delete=models.RESTRICT, blank=True, null=True
    )
    vinculacionCuotas = models.IntegerField(
        "Vincualacion cuotas", blank=True, null=True
    )
    vinculacionValor = models.IntegerField("Vinculacion valor", blank=True, null=True)
    vinculacionPendientePago = models.IntegerField(
        "Vinculacion valor", blank=True, null=True
    )
    estadoRegistro = models.BooleanField("Estado")
    fechaCreacion = models.DateTimeField(auto_now_add=True)
    fechaModificacion = models.DateTimeField(auto_now=True)
...
class RepatriacionTitular(models.Model):
    ...
    paisRepatriacion = models.ForeignKey(
        PaisRepatriacion, on_delete=models.RESTRICT, blank=True, null=True
    )
...
class ConveniosAsociado(models.Model):
    ...
    convenio = models.ForeignKey(
        Convenio, on_delete=models.RESTRICT, blank=False, null=False
    )
    asociado = models.ForeignKey(
        Asociado, on_delete=models.RESTRICT, blank=False, null=False
    )
...
class ConvenioHistoricoGasolina(models.Model):
    ...
    convenio = models.ForeignKey(
        ConveniosAsociado, on_delete=models.RESTRICT, blank=False, null=False
    )
    mes_tarifa = models.ForeignKey(
        MesTarifa, on_delete=models.RESTRICT, blank=False, null=False
    )
...
class RadicadoAsociado(models.Model):
    ...
    asociado = models.ForeignKey(
        "Asociado", on_delete=models.CASCADE, related_name="radicados"
    )
    ...
    proceso = models.CharField(
        max_length=20, choices=PROCESO_CHOICES, blank=True, null=True
    )
    fecha_creacion = models.DateTimeField(auto_now_add=True)
